...
public class CopyOfAuditeurCNAMTest extends junit.framework.TestCase {
    ...
    public void test_toString() {
        question3.AuditeurCNAM auditeur1 = new question3.AuditeurCNAM("MAGGIE",
                "élément", "03-1234");
        assertEquals("MAGGIE élément login : maggie_e", auditeur1.toString());
    }

    public void test_nom_court() {
        question3.AuditeurCNAM auditeur1 = new question3.AuditeurCNAM("Marie-José",
                "CATASTROPHE", "12345");
        assertEquals("Marie-José", auditeur1.nom());
        assertEquals("CATASTROPHE", auditeur1.prenom());
        assertEquals("marie__c", auditeur1.login());
    }

    public void test_nom_court_bis() {
        question3.AuditeurCNAM auditeur1 = new question3.AuditeurCNAM("Anomalie/Célébrale",
                "äge", "12345");
        assertEquals("Mme Anomalie/Célébrale äge", "Anomalie/Célébrale", auditeur1.nom());
        assertEquals("Mme Anomalie/Célébrale äge", "äge", auditeur1.prenom());
        assertEquals("Mme Anomalie/Célébrale äge", "anomal_a", auditeur1.login());
    }

    public void test_nom_avec_particule() {
        question3.AuditeurCNAM auditeur1 = new question3.AuditeurCNAM(
                "à temps", "pêcher", "12345");
        assertEquals("Mr à temps ponctuel ", "à temps", auditeur1.nom());
        assertEquals("Mr à temps ponctuel ", "pêcher", auditeur1.prenom());
